...
export function AppStoreButton({
  ...
  return (
    <Button variant="default" className={cn("h-14 px-6 gap-3 rounded-xl border border-surface-800 shadow-md", className)} {...props}>
      <AppleIcon className="size-6 text-white" fill="currentColor" />
      <div className="text-left flex flex-col items-start justify-center pr-2">
        <span className="text-[11px] leading-none tracking-tighter text-white/80">
          Download on the
        </span>
        <p className="text-lg font-bold leading-none text-white mt-1">App Store</p>
      </div>
    </Button>
  );
}
